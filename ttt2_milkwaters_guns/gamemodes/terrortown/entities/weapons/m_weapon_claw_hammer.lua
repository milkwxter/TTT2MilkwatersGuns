...
if( CLIENT ) then
	...
	SWEP.DrawAmmo = false
	SWEP.Icon = "materials/milkwaters_icons/vgui/ttt/icon_claw_hammer.png"
end
...
SWEP.ViewModel      = "models/weapons/claw_hammer/v_knife_t.mdl"
SWEP.WorldModel   	= "models/weapons/claw_hammer/w_knife_t.mdl"
